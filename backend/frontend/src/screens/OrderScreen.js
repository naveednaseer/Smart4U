                ...
                <Col md={8}>
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            {order.isDelivered ? (
                                <h5 className="text-center">
                                    {/* <Message variant='primary'>Delivered on: {order.deliveredAt} ?{order.deliveredAt.substring(0, 10)}</Message> */}
                                    {order.deliveredAt ? (
                                            <Message variant='primary'>Delivered on: {order.paidAt.substring(0, 10)} </Message>
                                        ) : 
                                            <Message variant='primary'>Delivered But Date Not Entered</Message>
                                        }
                                </h5>
                            ) : (
                                <h5 className="text-center">
                        ...
                        <ListGroup.Item>
                            ...
                            {order.isPaid ? (
                                <h5 className="text-center">
                                    {/* <Message variant='primary'>Paid on: ({order.paidAt} ? {order.paidAt.substring(0, 10)} : <>"Not Entered"</>)</Message> */}
                                    {order.paidAt ? (
                                        <Message variant='primary'>Paid on: {order.paidAt.substring(0, 10)} </Message>
                                    ) : 
                                        <Message variant='primary'>Paid But Date Not Entered</Message>
                                    }
                                </h5>
                            ) : (
                                <h5 className="text-center">
                                    <Message variant='info'>Your order has been created. <br /> Payment for your order is still pending </Message>  
                                </h5>   
                            )}
